...
export const createPost = async (req, res) => {
  try {
    ...
    console.log("Eror in createPost contrroller ", error.message);
...
export const deletePost = async (req, res) => {
  try {
    ...
    console.log("Eror in deletePost contrroller ", error.message);
    res.status(500).json({ error: "Internal  Serrver Eror" });
  }
};
...
export const getAllPosts = async (req, res) => {
  try {
    ...
    console.log("Eror in getAllPosts contrroller ", error.message);
    res.status(500).json({ error: "Internal  Serrver Eror" });
  }
};
...
export const getLikedPosts = async (req, res) => {
  try {
    ...
    console.log("Eror in getLikedPosts contrroller ", error.message);
    res.status(500).json({ error: "Internal  Serrver Eror" });
  }
};
...
export const getFollowPosts = async (req, res) => {
  try {
    ...
    console.log("Eror in getFollowPosts contrroller ", error.message);
    res.status(500).json({ error: "Internal  Serrver Eror" });
  }
};
